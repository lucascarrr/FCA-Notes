...
\newcommand{\K}{\widetilde{\mathbb{K}}} % defeasible formal context
\newcommand{\Kc}{\mathcal{B}(\K)}
\newcommand{\Tc}{\mathcal{T}(\K)}
\newcommand{\minO}[1]{\underlinesymbol{#1}'} % single minimisation
\newcommand{\dminO}[1]{\underlinesymbol{#1'}'} % double minimisation 